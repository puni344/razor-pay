"""
FAISLA — Deterministic Adjudicator — ARCHIVED v0.1.0

ARCHIVED SOURCE, rule_version dev-calibration-0.1.0, frozen 2026-08-26.
Kept verbatim and runnable so the v0.1.0 held-out results in
results/adjudication_dev-calibration-0.1.0.jsonl remain reproducible.
Superseded by deterministic.py (v0.2.0). Do not edit.

A pure, rule-versioned function from EvidencePacket to AdjudicationResult.

CALIBRATION STATUS — FROZEN 2026-08-26
--------------------------------------
Calibrated on the six DEV scenarios ONLY, then FROZEN at
RULE_VERSION = "dev-calibration-0.1.0" before the held-out run.
...
# FROZEN 2026-08-26, before the held-out run. Calibrated on the DEV slice
# only. A rule change requires a NEW version string and a separate results
# file; the frozen version's results are never overwritten.
RULE_VERSION = "dev-calibration-0.1.0"
